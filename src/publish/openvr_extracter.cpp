...
//Added by Yifei Shao 4/13/18, adopt from https://www.codeproject.com/Articles/1171122/How-to-Get-Raw-Positional-Data-from-HTC-Vive
//-----------------------------------------------------------------------------
...
void CMainApplication::printDevicePositionalData(const char * deviceName, vr::HmdMatrix34_t posMatrix, vr::HmdVector3_t position, vr::HmdQuaternion_t quaternion)
{
	...
	myfile << qpc.QuadPart <<",x: " << position.v[0] << ",y: " << position.v[1] << ",z: " << position.v[2] << ",qw: " << quaternion.w << ",qx: " << quaternion.x << ",qy: " <<
		quaternion.y << ",qz: " << quaternion.z << ",device: " << deviceName<< std::endl;
	myfile.close();
	std::cout << qpc.QuadPart << ",x: " << position.v[0] << ",y: " << position.v[1] << ",z: " << position.v[2] << ",qw: " << quaternion.w << ",qx: " << quaternion.x << ",qy: " <<
		quaternion.y << ",qz: " << quaternion.z << std::endl;
...
bool CMainApplication::HandleInput()
{
	...
	//output position data to pubnub
	printPositionalData();
